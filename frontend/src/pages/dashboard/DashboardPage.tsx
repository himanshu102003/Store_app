    ...
    <div className="py-6">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        {(user?.role === 'store_owner' || user?.role === 'admin') && (
          <div className="mt-8">
            <h2 className="text-lg font-medium text-gray-900">Store Owner Dashboard</h2>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6">
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        <dt className="text-sm font-medium text-gray-500 truncate">My Stores</dt>
                        <dd>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        ...
                        <dd>
                          <div className="text-lg font-medium text-gray-900">0.0</div>
                        </dd>
                      </dl>
                    </div>
                  </div>
